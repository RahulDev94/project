<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Addproduct.aspx.cs" Inherits="project.Addproduct" %>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList1" runat="server">
                    ...
                    <asp:ListItem Value="2">Watch</asp:ListItem>
                    <asp:ListItem Value="3">Laptop</asp:ListItem>
                    <asp:ListItem Value="4">Earphone</asp:ListItem>
                    <asp:ListItem Value="5">Camera</asp:ListItem>
                    <asp:ListItem Value="6">TV</asp:ListItem>
                </asp:DropDownList>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
